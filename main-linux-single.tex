% ============================================================
% 双栏中文学术论文模版 — Linux 单栏版
% 中文字体：Fandol（TeX Live 自带，无需额外安装）
% 英文字体：TeX Gyre Termes / Heros / Cursor（Times/Arial/Courier 的开源替代）
% 编译：xelatex main-linux-single.tex
% ============================================================
...
% ---- 字体（TeX Gyre 系列，TeX Live 自带）----
\usepackage{fontspec}
\setmainfont{TeX Gyre Termes}   % Times New Roman 的开源替代
\setsansfont{TeX Gyre Heros}    % Arial/Helvetica 的开源替代
\setmonofont{TeX Gyre Cursor}   % Courier New 的开源替代
...
正文使用 10pt TeX Gyre Termes（英文）与宋体（中文）。
